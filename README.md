...
* **นักพัฒนา PHP ที่อยากอัปเกรด:** สำหรับคนที่เคยทำเว็บด้วย PHP แบบเดิมๆ (เช่น ผสมโค้ดในไฟล์เดียว, ทำเว็บด้วย WordPress) และอยากจะก้าวเข้าสู่โลกของการพัฒนาแอปพลิเคชันสมัยใหม่ คอร์สนี้คือประตูบานแรกที่ดีที่สุดครับ
...
* **คนที่อยากเข้าใจ "ภาพใหญ่":** สำหรับใครก็ตามที่อยากเข้าใจว่าเว็บแอปหรือแอปมือถือที่เราใช้กันทุกวันนี้มันมีโครงสร้างเบื้องหลังอย่างไร คอร์สนี้จะทำให้คุณ "อ๋อ!" ขึ้นมาทันที

### 3. ควรมีความรู้พื้นฐานอะไรมาก่อนบ้าง?
